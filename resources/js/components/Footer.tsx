...
export default function Footer() {
  return (
    <footer className="flex items-center font-mono justify-center py-4 text-gray-500 flex-col text-sm sm:text-xs text-center px-2">
      ...
      <div className="text-[0.8rem] sm:text-base text-white mb-10">
        ...
        <div>&copy; 2022 Exun Clan and DPS RK Puram, New Delhi, India</div>
      </div>
    </footer>
  );
}
